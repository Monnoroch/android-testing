...
/**
 * A rule to be used for unlocking screen.
 * Screen will be unlocked before each test annotated with @Test and
        ...
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                activityRule.runOnUiThread(() -> {
                    activityRule.getActivity().getWindow().addFlags(WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED
