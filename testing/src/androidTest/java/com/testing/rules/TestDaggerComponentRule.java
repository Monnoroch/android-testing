...
/**
 * A rule to be used for replace dagger component.
 * Component will be replaced before each test annotated with @Test and
 *     before methods annotated with @Before.
 * Original component will be returned after the test is completed.
 */
    ...
    public Statement apply(Statement statement, Description description) {
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                MainApplication application = ((MainApplication) activityRule.getActivity().getApplication());
