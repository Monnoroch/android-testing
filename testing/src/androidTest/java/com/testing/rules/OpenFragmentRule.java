...
/**
 * A rule to be used for testing of a single fragment.
 * Fragment will be opened before each test annotated with @Test and
 *     before methods annotated with @Before.
 * During the duration of the test you will be able to manipulate Fragment directly.
 *
